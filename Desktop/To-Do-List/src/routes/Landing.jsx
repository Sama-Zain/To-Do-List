    ...
    <h1 className="text-3xl font-[Oswald]  pl-30 text-shadow-lg pb-4" >ToDo Py</h1>
     ...
     <p>prioritixe their daily activities and</p>
       <p>responsibilities.</p>
        ...
        <button className=" bg-[var(--btn-color)] cursor-pointer shadow-xl text-black font-semibold  p-2 rounded-xl w-80 hover:scale-105 transition-all duration-300">Get Started</button>
